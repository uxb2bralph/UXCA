...
namespace ContractHome.Models.Dto
{
    public class PostFieldSettingRequest
    {
        ...
        public class PostFieldSettingRequestFields
        {
            ...
            public PostFieldSettingRequestFields(string companyID, string iD, double scaleWidth, double scaleHeight, double marginTop, double marginLeft, int pageIndex, int type)
            {
                CompanyID = companyID;
                ID = iD;
