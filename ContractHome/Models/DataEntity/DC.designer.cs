...
namespace ContractHome.Models.DataEntity
{
    ...
    partial void InsertContractCategory(ContractCategory instance);
    partial void UpdateContractCategory(ContractCategory instance);
    partial void DeleteContractCategory(ContractCategory instance);
    partial void InsertContractCategoryPermission(ContractCategoryPermission instance);
    partial void UpdateContractCategoryPermission(ContractCategoryPermission instance);
    partial void DeleteContractCategoryPermission(ContractCategoryPermission instance);
    ...
    partial void DeleteUserRoleDefinition(UserRoleDefinition instance);
		...
		public System.Data.Linq.Table<ContractCategory> ContractCategory
		{
			get
			{
				return this.GetTable<ContractCategory>();
			}
		}
		
		public System.Data.Linq.Table<ContractCategoryPermission> ContractCategoryPermission
		{
			get
			{
				return this.GetTable<ContractCategoryPermission>();
			}
		}
    ...
    partial void OnProcessTypeChanged();
		...
		[Column(Storage="_DocID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int DocID
		{
			get
			{
		...
		[Column(Storage="_DocType", DbType="Int")]
		...
		[Column(Storage="_DocDate", DbType="DateTime NOT NULL")]
		...
		[Column(Storage="_CurrentStep", DbType="Int")]
		...
		[Column(Storage="_ProcessType", DbType="Int")]
		...
		[Association(Name="FK_Contract_CDS_Document", Storage="_Contract", ThisKey="DocID", OtherKey="ContractID", IsUnique=true, IsForeignKey=false, DeleteRule="CASCADE")]
		...
		[Association(Name="FK_DocumentProcessLog_CDS_Document", Storage="_DocumentProcessLog", ThisKey="DocID", OtherKey="DocID", DeleteRule="CASCADE")]
    ...
    partial void OnThirdPartyClusterIDChanged();
		...
		[Column(Storage="_Token", DbType="NVarChar(64) NOT NULL", CanBeNull=false)]
		public string Token
		{
			get
			{
		...
		[Column(Storage="_ClusterID", DbType="NVarChar(64) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_ApplicationKey", DbType="NVarChar(MAX) NOT NULL", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_ThirdPartyClusterID", DbType="NVarChar(64) NOT NULL", CanBeNull=false)]
		...
		[Association(Name="FK_CHT_Token_Organization", Storage="_Organization", ThisKey="CompanyID", OtherKey="CompanyID", IsForeignKey=true, DeleteOnNull=true)]
    ...
    partial void OnContractCategoryIDChanged();
		...
		[Column(Storage="_ContractNo", DbType="NVarChar(64) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_ContractContent", DbType="VarBinary(MAX)", CanBeNull=true, UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_IsPassStamp", DbType="Bit")]
		...
		[Column(Storage="_UserInProgress", DbType="Int")]
		...
		[Column(Storage="_NotifyUntilDate", DbType="DateTime")]
		...
		[Column(Storage="_ContractCategoryID", DbType="Int NOT NULL")]
		public int ContractCategoryID
		{
			get
			{
				return this._ContractCategoryID;
			}
			set
			{
				if ((this._ContractCategoryID != value))
				{
					this.OnContractCategoryIDChanging(value);
					this.SendPropertyChanging();
					this._ContractCategoryID = value;
					this.SendPropertyChanged("ContractCategoryID");
					this.OnContractCategoryIDChanged();
				}
			}
		}
		
		[Association(Name="FK_Contract_CDS_Document", Storage="_CDS_Document", ThisKey="ContractID", OtherKey="DocID", IsForeignKey=true, DeleteOnNull=true)]
		...
		[Association(Name="FK_ContractingParty_Contract", Storage="_ContractingParty", ThisKey="ContractID", OtherKey="ContractID", DeleteRule="CASCADE")]
		...
		[Association(Name="FK_ContractNoteRequest_Contract", Storage="_ContractNoteRequest", ThisKey="ContractID", OtherKey="ContractID", DeleteRule="CASCADE")]
		...
		[Association(Name="FK_ContractSealRequest_Contract", Storage="_ContractSealRequest", ThisKey="ContractID", OtherKey="ContractID", DeleteRule="CASCADE")]
		...
		[Association(Name="FK_ContractSignature_Contract", Storage="_ContractSignature", ThisKey="ContractID", OtherKey="ContractID", IsUnique=true, IsForeignKey=false, DeleteRule="CASCADE")]
		...
		[Association(Name="FK_ContractSignaturePositionRequest_Contract", Storage="_ContractSignaturePositionRequest", ThisKey="ContractID", OtherKey="ContractID", DeleteRule="CASCADE")]
		...
		[Association(Name="FK_ContractSignatureRequest_Contract", Storage="_ContractSignatureRequest", ThisKey="ContractID", OtherKey="ContractID", DeleteRule="CASCADE")]
	...
	[Table(Name="dbo.ContractCategory")]
	public partial class ContractCategory : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _ModifyUID;
    ...
    partial void OnModifyUIDChanging(System.Nullable<int> value);
    partial void OnModifyUIDChanged();
    ...
    partial void OnModifyDateChanged();
		...
		[Column(Storage="_ContractCategoryID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int ContractCategoryID
		{
			get
			{
		...
		[Column(Storage="_CategoryName", DbType="NChar(10) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_CreateUID", DbType="Int NOT NULL")]
		...
		[Column(Storage="_ModifyUID", DbType="Int")]
		public System.Nullable<int> ModifyUID
		{
			get
			{
				return this._ModifyUID;
			}
			set
			{
				if ((this._ModifyUID != value))
				{
					this.OnModifyUIDChanging(value);
					this.SendPropertyChanging();
					this._ModifyUID = value;
					this.SendPropertyChanged("ModifyUID");
					this.OnModifyUIDChanged();
				}
			}
		}
	...
	[Table(Name="dbo.ContractCategoryPermission")]
	public partial class ContractCategoryPermission : INotifyPropertyChanging, INotifyPropertyChanged
	{
		
		private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(String.Empty);
		
		private int _ContractCategoryPermissionID;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnContractCategoryPermissionIDChanging(int value);
    partial void OnContractCategoryPermissionIDChanged();
    partial void OnContractCategoryIDChanging(int value);
    partial void OnContractCategoryIDChanged();
    ...
    partial void OnCreateDateChanged();
		...
		public ContractCategoryPermission()
		{
			OnCreated();
		}
		
		[Column(Storage="_ContractCategoryPermissionID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int ContractCategoryPermissionID
		{
			get
			{
				return this._ContractCategoryPermissionID;
			}
			set
			{
				if ((this._ContractCategoryPermissionID != value))
				{
					this.OnContractCategoryPermissionIDChanging(value);
					this.SendPropertyChanging();
					this._ContractCategoryPermissionID = value;
					this.SendPropertyChanged("ContractCategoryPermissionID");
					this.OnContractCategoryPermissionIDChanged();
				}
			}
		}
	...
	[Table(Name="dbo.ContractingIntent")]
    ...
    partial void OnDescriptionChanged();
		...
		[Column(Storage="_IntentID", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int IntentID
		{
			get
			{
		...
		[Column(Storage="_Description", DbType="NVarChar(64) NOT NULL", CanBeNull=false)]
		...
		[Association(Name="FK_ContractingParty_ContractingIntent", Storage="_ContractingParty", ThisKey="IntentID", OtherKey="IntentID", DeleteRule="NO ACTION")]
		public EntitySet<ContractingParty> ContractingParty
		{
			get
			{
		...
		[Association(Name="FK_SealTemplate_ContractingIntent", Storage="_SealTemplate", ThisKey="IntentID", OtherKey="IntentID", DeleteRule="NO ACTION")]
	...
	[Table(Name="dbo.ContractingParty")]
    ...
    partial void OnIsInitiatorChanged();
		...
		[Column(Storage="_IsInitiator", DbType="Bit")]
		...
		[Association(Name="FK_ContractingParty_Contract", Storage="_Contract", ThisKey="ContractID", OtherKey="ContractID", IsForeignKey=true, DeleteOnNull=true)]
		public Contract Contract
		{
			get
			{
		...
		[Association(Name="FK_ContractingParty_ContractingIntent", Storage="_ContractingIntent", ThisKey="IntentID", OtherKey="IntentID", IsForeignKey=true)]
		...
		[Association(Name="FK_ContractingParty_Organization", Storage="_Organization", ThisKey="CompanyID", OtherKey="CompanyID", IsForeignKey=true)]
		public Organization Organization
		{
			get
			{
	...
	[Table(Name="dbo.ContractNoteRequest")]
    ...
    partial void OnPageIndexChanged();
		...
		[Column(Storage="_StampDate", DbType="DateTime")]
		...
		[Column(Storage="_Note", DbType="NVarChar(MAX)", UpdateCheck=UpdateCheck.Never)]
		public string Note
		{
			get
			{
		...
		[Column(Storage="_StampUID", DbType="Int")]
		...
		[Column(Storage="_SealScale", DbType="Float")]
		...
		[Association(Name="FK_ContractNoteRequest_Contract", Storage="_Contract", ThisKey="ContractID", OtherKey="ContractID", IsForeignKey=true, DeleteOnNull=true)]
		public Contract Contract
		{
			get
			{
		...
		[Association(Name="FK_ContractNoteRequest_UserProfile", Storage="_UserProfile", ThisKey="StampUID", OtherKey="UID", IsForeignKey=true)]
	...
	[Table(Name="dbo.ContractSealRequest")]
    ...
    partial void OnPageIndexChanged();
		...
		[Column(Storage="_SealID", DbType="Int NOT NULL")]
		public int SealID
		{
			get
			{
		...
		[Column(Storage="_SealImage", DbType="VarBinary(MAX)", CanBeNull=true, UpdateCheck=UpdateCheck.Never)]
		...
		[Association(Name="FK_ContractSealRequest_Contract", Storage="_Contract", ThisKey="ContractID", OtherKey="ContractID", IsForeignKey=true, DeleteOnNull=true)]
		public Contract Contract
		{
			get
			{
		...
		[Association(Name="FK_ContractSealRequest_SealTemplate", Storage="_SealTemplate", ThisKey="SealID", OtherKey="SealID", IsForeignKey=true)]
		...
		[Association(Name="FK_ContractSealRequest_UserProfile", Storage="_UserProfile", ThisKey="StampUID", OtherKey="UID", IsForeignKey=true)]
		public UserProfile UserProfile
		{
			get
			{
	...
	[Table(Name="dbo.ContractSignature")]
    ...
    partial void OnCompanyIDChanged();
		...
		[Association(Name="FK_ContractSignature_Contract", Storage="_Contract", ThisKey="ContractID", OtherKey="ContractID", IsForeignKey=true, DeleteOnNull=true)]
		public Contract Contract
		{
			get
			{
		...
		[Association(Name="FK_ContractSignature_ContractSignatureRequest", Storage="_ContractSignatureRequest", ThisKey="ContractID,CompanyID", OtherKey="ContractID,CompanyID", IsForeignKey=true)]
	...
	[Table(Name="dbo.ContractSignaturePositionRequest")]
	...
	[Table(Name="dbo.ContractSignatureRequest")]
    ...
    partial void OnRequestTicketChanged();
		...
		[Column(Storage="_SignerID", DbType="Int")]
		...
		[Column(Storage="_RequestPath", DbType="NVarChar(256)")]
		...
		[Column(Storage="_ResponsePath", DbType="NVarChar(256)")]
		...
		[Column(Storage="_RequestTicket", DbType="NVarChar(64)")]
		...
		[Association(Name="FK_ContractSignature_ContractSignatureRequest", Storage="_ContractSignature", ThisKey="ContractID,CompanyID", OtherKey="ContractID,CompanyID", DeleteRule="NO ACTION")]
		...
		[Association(Name="FK_ContractSignatureRequest_Contract", Storage="_Contract", ThisKey="ContractID", OtherKey="ContractID", IsForeignKey=true, DeleteOnNull=true)]
		public Contract Contract
		{
			get
			{
		...
		[Association(Name="FK_ContractSignatureRequest_Organization", Storage="_Organization", ThisKey="CompanyID", OtherKey="CompanyID", IsForeignKey=true)]
		public Organization Organization
		{
			get
			{
		...
		[Association(Name="FK_ContractSignatureRequest_UserProfile", Storage="_UserProfile", ThisKey="SignerID", OtherKey="UID", IsForeignKey=true)]
		public UserProfile UserProfile
		{
			get
			{
	...
	[Table(Name="dbo.DocumentProcessLog")]
    ...
    partial void OnClientDeviceChanged();
		...
		[Column(Storage="_DocID", DbType="Int NOT NULL")]
		public int DocID
		{
			get
			{
		...
		[Column(Storage="_StepID", DbType="Int NOT NULL")]
		public int StepID
		{
			get
			{
		...
		[Column(Storage="_ActorID", DbType="Int")]
		...
		[Column(Storage="_ClientIP", DbType="VarChar(50)")]
		...
		[Column(Storage="_ClientDevice", DbType="NVarChar(512)")]
		...
		[Association(Name="FK_DocumentProcessLog_CDS_Document", Storage="_CDS_Document", ThisKey="DocID", OtherKey="DocID", IsForeignKey=true, DeleteOnNull=true)]
		public CDS_Document CDS_Document
		{
			get
			{
		...
		[Association(Name="FK_DocumentProcessLog_UserProfile", Storage="_UserProfile", ThisKey="ActorID", OtherKey="UID", IsForeignKey=true)]
		public UserProfile UserProfile
		{
			get
			{
    ...
    partial void OnBindingUIDChanged();
		...
		[Column(Storage="_SeqNo", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int SeqNo
		{
			get
			{
		...
		[Column(Storage="_X509Certificate", DbType="NVarChar(MAX) NOT NULL", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_CertificateType", DbType="NChar(10) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_BindingUID", DbType="Int NOT NULL")]
		...
		[Association(Name="FK_IdentityCert_UserProfile", Storage="_UserProfile", ThisKey="BindingUID", OtherKey="UID", IsForeignKey=true)]
		public UserProfile UserProfile
		{
			get
			{
    ...
    partial void OnCanCreateContractChanged();
		...
		[Column(Storage="_ReceiptNo", DbType="NVarChar(10) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_Phone", DbType="NVarChar(64)")]
		public string Phone
		{
			get
			{
		...
		[Column(Storage="_ContactFax", DbType="NVarChar(20)")]
		...
		[Column(Storage="_ContactMobilePhone", DbType="NVarChar(20)")]
		...
		[Column(Storage="_RegAddr", DbType="NVarChar(256)")]
		...
		[Column(Storage="_UndertakerName", DbType="NVarChar(50)")]
		...
		[Column(Storage="_Addr", DbType="NVarChar(256)")]
		public string Addr
		{
			get
			{
		...
		[Column(Storage="_EnglishAddr", DbType="NVarChar(256)")]
		...
		[Column(Storage="_EnglishRegAddr", DbType="NVarChar(256)")]
		...
		[Column(Storage="_ContactEmail", DbType="NVarChar(512)")]
		...
		[Column(Storage="_UndertakerPhone", DbType="NVarChar(20)")]
		...
		[Column(Storage="_UndertakerFax", DbType="NVarChar(20)")]
		...
		[Column(Storage="_UndertakerMobilePhone", DbType="NVarChar(20)")]
		...
		[Column(Storage="_InvoiceSignature", DbType="NVarChar(64)")]
		...
		[Column(Storage="_UndertakerID", DbType="NVarChar(16)")]
		...
		[Column(Storage="_ContactTitle", DbType="NVarChar(16)")]
		...
		[Column(Storage="_CompanyBelongTo", DbType="Int")]
		...
		[Column(Storage="_CanCreateContract", DbType="Bit")]
		...
		[Association(Name="FK_CHT_Token_Organization", Storage="_CHT_Token", ThisKey="CompanyID", OtherKey="CompanyID", IsUnique=true, IsForeignKey=false, DeleteRule="CASCADE")]
		...
		[Association(Name="FK_ContractingParty_Organization", Storage="_ContractingParty", ThisKey="CompanyID", OtherKey="CompanyID", DeleteRule="NO ACTION")]
		public EntitySet<ContractingParty> ContractingParty
		{
			get
			{
		...
		[Association(Name="FK_ContractSignatureRequest_Organization", Storage="_ContractSignatureRequest", ThisKey="CompanyID", OtherKey="CompanyID", DeleteRule="NO ACTION")]
		public EntitySet<ContractSignatureRequest> ContractSignatureRequest
		{
			get
			{
		...
		[Association(Name="FK_OrganizationStatus_Organization", Storage="_OrganizationStatus", ThisKey="CompanyID", OtherKey="CompanyID", IsUnique=true, IsForeignKey=false, DeleteRule="CASCADE")]
		...
		[Association(Name="FK_OrganizationToken_Organization", Storage="_OrganizationToken", ThisKey="CompanyID", OtherKey="CompanyID", IsUnique=true, IsForeignKey=false, DeleteRule="CASCADE")]
		...
		[Association(Name="FK_OrganizationUser_Organization", Storage="_OrganizationUser", ThisKey="CompanyID", OtherKey="CompanyID", DeleteRule="NO ACTION")]
	...
	[Table(Name="dbo.OrganizationStatus")]
    ...
    partial void OnLevelIDChanged();
		...
		[Column(Storage="_LevelID", DbType="Int")]
		...
		[Association(Name="FK_OrganizationStatus_Organization", Storage="_Organization", ThisKey="CompanyID", OtherKey="CompanyID", IsForeignKey=true, DeleteOnNull=true)]
		public Organization Organization
		{
			get
			{
	...
	[Table(Name="dbo.OrganizationToken")]
    ...
    partial void OnIsActivatedChanged();
		...
		[Column(Storage="_Thumbprint", DbType="NVarChar(256) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_PKCS12", DbType="NVarChar(MAX)", UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_KeyID", DbType="UniqueIdentifier")]
		...
		[Column(Storage="_IsActivated", DbType="Bit")]
		...
		[Association(Name="FK_OrganizationToken_Organization", Storage="_Organization", ThisKey="CompanyID", OtherKey="CompanyID", IsForeignKey=true, DeleteOnNull=true)]
		public Organization Organization
		{
			get
			{
	...
	[Table(Name="dbo.OrganizationUser")]
    ...
    partial void OnCompanyIDChanged();
		...
		[Association(Name="FK_OrganizationUser_Organization", Storage="_Organization", ThisKey="CompanyID", OtherKey="CompanyID", IsForeignKey=true)]
		public Organization Organization
		{
			get
			{
		...
		[Association(Name="FK_OrganizationUser_UserProfile", Storage="_UserProfile", ThisKey="UID", OtherKey="UID", IsForeignKey=true, DeleteOnNull=true)]
		public UserProfile UserProfile
		{
			get
			{
    ...
    partial void OnDisabledChanged();
		...
		[Column(Storage="_SealID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int SealID
		{
			get
			{
		...
		[Column(Storage="_Intent", DbType="NVarChar(64)")]
		...
		[Column(Storage="_IntentID", DbType="Int")]
		...
		[Column(Storage="_Disabled", DbType="Bit")]
		...
		[Association(Name="FK_ContractSealRequest_SealTemplate", Storage="_ContractSealRequest", ThisKey="SealID", OtherKey="SealID", DeleteRule="NO ACTION")]
		public EntitySet<ContractSealRequest> ContractSealRequest
		{
			get
			{
		...
		[Association(Name="FK_SealTemplate_ContractingIntent", Storage="_ContractingIntent", ThisKey="IntentID", OtherKey="IntentID", IsForeignKey=true)]
		public ContractingIntent ContractingIntent
		{
			get
			{
		...
		[Association(Name="FK_SealTemplate_UserProfile", Storage="_UserProfile", ThisKey="UID", OtherKey="UID", IsForeignKey=true)]
		public UserProfile UserProfile
		{
			get
			{
    ...
    partial void OnPasswordUpdatedDateChanged();
		...
		[Column(Storage="_UserName", DbType="NVarChar(40)")]
		...
		[Column(Storage="_PID", DbType="NVarChar(64) NOT NULL", CanBeNull=false)]
		public string PID
		{
			get
			{
		...
		[Column(Storage="_Address", DbType="NVarChar(128)")]
		...
		[Column(Storage="_City", DbType="NVarChar(16)")]
		public string City
		{
			get
			{
		...
		[Column(Storage="_Region", DbType="NVarChar(16)")]
		...
		[Column(Storage="_Country", DbType="NVarChar(16)")]
		...
		[Column(Storage="_MobilePhone", DbType="NVarChar(24)")]
		...
		[Column(Storage="_Phone2", DbType="NVarChar(64)")]
		...
		[Column(Storage="_Fax", DbType="NVarChar(64)")]
		public string Fax
		{
			get
			{
		...
		[Column(Storage="_EMail", DbType="NVarChar(512)")]
		public string EMail
		{
			get
			{
		...
		[Column(Storage="_Expiration", DbType="DateTime")]
		...
		[Column(Storage="_AuthID", DbType="Int")]
		...
		[Column(Storage="_ThemeName", DbType="NVarChar(16)")]
		...
		[Column(Storage="_Password2", DbType="NVarChar(64)")]
		...
		[Column(Storage="_MailID", DbType="NVarChar(64)")]
		...
		[Column(Storage="_LoginFailedCount", DbType="Int")]
		...
		[Column(Storage="_PasswordUpdatedDate", DbType="DateTime")]
		...
		[Association(Name="FK_ContractNoteRequest_UserProfile", Storage="_ContractNoteRequest", ThisKey="UID", OtherKey="StampUID", DeleteRule="NO ACTION")]
		public EntitySet<ContractNoteRequest> ContractNoteRequest
		{
			get
			{
		...
		[Association(Name="FK_ContractSealRequest_UserProfile", Storage="_ContractSealRequest", ThisKey="UID", OtherKey="StampUID", DeleteRule="NO ACTION")]
		public EntitySet<ContractSealRequest> ContractSealRequest
		{
			get
			{
		...
		[Association(Name="FK_ContractSignatureRequest_UserProfile", Storage="_ContractSignatureRequest", ThisKey="UID", OtherKey="SignerID", DeleteRule="NO ACTION")]
		public EntitySet<ContractSignatureRequest> ContractSignatureRequest
		{
			get
			{
		...
		[Association(Name="FK_DocumentProcessLog_UserProfile", Storage="_DocumentProcessLog", ThisKey="UID", OtherKey="ActorID", DeleteRule="NO ACTION")]
		public EntitySet<DocumentProcessLog> DocumentProcessLog
		{
			get
			{
		...
		[Association(Name="FK_IdentityCert_UserProfile", Storage="_IdentityCert", ThisKey="UID", OtherKey="BindingUID", DeleteRule="NO ACTION")]
		...
		[Association(Name="FK_OrganizationUser_UserProfile", Storage="_OrganizationUser", ThisKey="UID", OtherKey="UID", IsUnique=true, IsForeignKey=false, DeleteRule="CASCADE")]
		...
		[Association(Name="FK_SealTemplate_UserProfile", Storage="_SealTemplate", ThisKey="UID", OtherKey="UID", DeleteRule="NO ACTION")]
		public EntitySet<SealTemplate> SealTemplate
		{
			get
			{
		...
		[Association(Name="FK_UserProfile_UserProfile", Storage="_CreatorUserProfile", ThisKey="Creator", OtherKey="UID", IsForeignKey=true)]
		...
		[Association(Name="FK_UserProfile_UserProfile", Storage="_UserProfile_UserProfile", ThisKey="UID", OtherKey="Creator", DeleteRule="NO ACTION")]
		...
		[Association(Name="FK_UserProfile_UserProfile1", Storage="_Auth", ThisKey="AuthID", OtherKey="UID", IsForeignKey=true)]
		...
		[Association(Name="FK_UserProfile_UserProfile1", Storage="_UserProfile_UserProfile1", ThisKey="UID", OtherKey="AuthID", DeleteRule="NO ACTION")]
		...
		[Association(Name="FK_UserRole_UserProfile", Storage="_UserRole", ThisKey="UID", OtherKey="UID", DeleteRule="CASCADE")]
    ...
    partial void OnRoleIDChanged();
		...
		[Association(Name="FK_UserRole_UserProfile", Storage="_UserProfile", ThisKey="UID", OtherKey="UID", IsForeignKey=true, DeleteOnNull=true)]
		public UserProfile UserProfile
		{
			get
			{
		...
		[Association(Name="FK_UserRole_UserRoleDefinition", Storage="_UserRoleDefinition", ThisKey="RoleID", OtherKey="RoleID", IsForeignKey=true)]
	...
	[Table(Name="dbo.UserRoleDefinition")]
    ...
    partial void OnRoleChanged();
		...
		[Association(Name="FK_UserRole_UserRoleDefinition", Storage="_UserRole", ThisKey="RoleID", OtherKey="RoleID", DeleteRule="NO ACTION")]
		public EntitySet<UserRole> UserRole
		{
			get
			{
