...
{
    public class PendingTerminationPrivilege : IEmailContent
    {
        public string Subject => @"[UX SIGN]合約建立權限即將終止通知信";
        ...
        public PendingTerminationPrivilege(IEmailBodyBuilder emailBodyBuilder)
        {
