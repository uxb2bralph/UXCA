...
using TWCACAPIAdapter.Controllers.Filters;
...
namespace TWCACAPIAdapter
{
    public class Startup
    {
        ...
        public Startup(IConfiguration configuration)
        {
            ...
            //Properties = Configuration.GetSection("TWCACAPIAdapter");
        ...
        {
            //var TWCACAPIAdapter = Configuration.GetSection("TWCACAPIAdapter");
            ...
            services.AddCors(options =>
            {
                ...
                options.AddPolicy("CorsPolicy", policy =>
                {
                    policy
                        ...
                        //.WithOrigins(Settings.Default.CORS_Origins)
                        .AllowAnyHeader()
                        .AllowAnyMethod()
                        .AllowCredentials();
                });
